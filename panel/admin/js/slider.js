...
(function(n) {
    function v(b, f) {
        ...
        a.st.arrowsNav && (e = a._o1, n('<div class="rsArrow rsArrowLeft"><div class="rsArrowIcn  icon icn-arr-left " style="font-size:35px"></div></div><div class="rsArrow rsArrowRight "><div class="rsArrowIcn icon icn-arr-right" style="font-size:35px"></div></div>').appendTo(e), a._c2 = e.children(".rsArrowLeft").click(function(b) {
            b.preventDefault();
            a.prev()
